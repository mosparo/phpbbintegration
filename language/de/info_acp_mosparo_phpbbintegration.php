...
$lang = array_merge($lang, [
    ...
    'ACP_MOSPARO_PHPBBINTEGRATION_HOWTO' => 'Um die Extension einzurichten, benötigst du ein mosparo-Projekt in einer mosparo-Installation. Weitere Informationen hierzu findest du auf <a href="https://mosparo.io/how-to-use/" target="_blank">unserer Website</a>.',
    ...
    'ACP_MOSPARO_PHPBBINTEGRATION_UUID_EXPLAIN' => 'Die eindeutige Identifikationsnummer deines Projektes.',
    'ACP_MOSPARO_PHPBBINTEGRATION_PUBLIC_KEY' => 'Öffentlicher Schlüssel',
    'ACP_MOSPARO_PHPBBINTEGRATION_PUBLIC_KEY_EXPLAIN' => 'Der öffentliche Schlüssel deines Projektes.',
    'ACP_MOSPARO_PHPBBINTEGRATION_PRIVATE_KEY' => 'Geheimer Schlüssel',
    'ACP_MOSPARO_PHPBBINTEGRATION_PRIVATE_KEY_EXPLAIN' => 'Der geheime Schlüssel deines Projektes.',
    'ACP_MOSPARO_PHPBBINTEGRATION_VERIFY_SSL' => 'SSL verifizieren',
    'ACP_MOSPARO_PHPBBINTEGRATION_VERIFY_SSL_EXPLAIN' => 'Entscheide, ob das mosparo-SSL-Zertifikat überprüft werden soll, wenn das Backend die Übermittlung überprüft. Wenn du ein selbstsigniertes Zertifikat verwendest, solltest du diese Option auf „Nein“ setzen; andernfalls sollte sie auf „Ja“ gesetzt sein.',
    ...
    'ACP_MOSPARO_PHPBBINTEGRATION_PROTECT_POSTING_EXPLAIN' => 'Legt fest, ob das Erstellen eines Beitrages mit mosparo geschützt ist (Neues Thema, Antworten) oder nicht. Falls ja, kannst du dies zusätzlich über die Forum-Berechtigungen für Forum-Rollen oder Foren selbst steuern, um zu entscheiden, wo der mosparo-Schutz gelten soll und wo nicht.',
